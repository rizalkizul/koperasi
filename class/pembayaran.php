<?php
	...
	*/
	class classPembayaran{
		...
		public function ubahPembayaran($id_pembayaran, $jenis, $status, $nominal){
			...
			$sqlUpdate = "UPDATE pembayaran SET jenis='$jenis', status='$status', nominal='$nominal' WHERE id_pembayaran='$id_pembayaran'";
